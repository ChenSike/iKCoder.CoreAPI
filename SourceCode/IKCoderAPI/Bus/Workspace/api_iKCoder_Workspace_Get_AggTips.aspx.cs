...
public partial class Bus_Workspace_api_iKCoder_Workspace_Get_AggTips : class_WebBase_IKCoderAPI_NUA
{
    protected override void ExtendedAction()
    {
        ...
        if (operation == class_CommonDefined._AllowSysOperation)
        {
            ...
            class_Data_SqlSPEntry activeSPEntry_configSence = Object_CommonData.GetActiveSP(Object_CommonData.dbServer, class_SPSMap.SP_OPERATION_CONFIG_TIPS);
