...
public partial class Bus_TeachingMan_M1_api_iKCoder_Teacher_GetHomeworkStatus : class_WebBase_IKCoderAPI_UA_Tm
{
    protected override void ExtendedAction()
    {
        ...
        else
        {
            ...
            class_Bus_HomeWork objectHomework = new class_Bus_HomeWork(Object_CommonData, logined_centersymbol);
