...
public partial class Bus_TeachingMan_M1_api_iKCoder_Teacher_GetLessonsLevel : class_WebBase_IKCoderAPI_UA_Tm
{
    protected override void ExtendedAction()
    {
        ...
        class_XmlHelper.SetAttribute(newItemNode, "symbol", class_CommonDefined.enumSenceType.primer.ToString());
        ...
        class_XmlHelper.SetAttribute(newItemNode, "symbol", class_CommonDefined.enumSenceType.middle.ToString());
        class_XmlHelper.SetAttribute(newItemNode, "value", "5002");
        resultDoc.SelectSingleNode("/root").AppendChild(newItemNode);
        newItemNode = class_XmlHelper.CreateNode(resultDoc, "item", "");
        class_XmlHelper.SetAttribute(newItemNode, "symbol", class_CommonDefined.enumSenceType.senior.ToString());
        class_XmlHelper.SetAttribute(newItemNode, "value", "5003");
        resultDoc.SelectSingleNode("/root").AppendChild(newItemNode);
        newItemNode = class_XmlHelper.CreateNode(resultDoc, "item", "");
        class_XmlHelper.SetAttribute(newItemNode, "symbol", class_CommonDefined.enumSenceType.advanced.ToString());
