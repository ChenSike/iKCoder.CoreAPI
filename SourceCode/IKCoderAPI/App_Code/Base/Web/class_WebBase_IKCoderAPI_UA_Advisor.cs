...
/// <summary>
/// Summary description for class_WebBase_IKCoderAPI_UA_Advisor
/// </summary>
public class class_WebBase_IKCoderAPI_UA_Advisor : class_WebBase_IKCoderAPI
{
    ...
    protected override bool BeforeExtenedAction()
    {
        ...
        if (Request.Cookies["logined_marked"] != null && Request.Cookies["logined_user_signedid"] != null && Request.Cookies["logined_user_id"] != null && Session["logined_user_name"] != null)
        {
            ...
            if (Session["logined_user_id"].ToString() == logined_user_id)
            {
                ...
                {
                    if (Session["logined_marked"].ToString() == class_CommonDefined.enumLoginedMark.mark_advisor.ToString())
                    {
                        Dictionary<String, String> attrs = new Dictionary<string, string>();
                        attrs.Add("logined_user_name", Session["logined_user_name"].ToString());
                        attrs.Add("logined_marked", class_CommonDefined.enumLoginedMark.mark_advisor.ToString());
                        attrs.Add("type", "1");
