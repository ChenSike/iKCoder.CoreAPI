...
public partial class Account_Teacher_api_iKCoder_Teacher_Set_Sign : class_WebBase_IKCoderAPI_NUA
{
    protected override void ExtendedAction()
    {
        string logined_mark = class_CommonDefined.enumLoginedMark.mark_teacher.ToString();
